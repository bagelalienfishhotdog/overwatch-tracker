-- ============================================
-- OVERWATCH - Complete Database Setup
...
-- Players: authenticated users can read, system can write
...
-- Servers: authenticated users can read, system can write
...
-- Perimeters: authenticated users can read, system can write
...
-- Create admin profile (uses existing auth.users entry)
DO $$
DECLARE
  admin_uuid UUID;
BEGIN
  ...
  IF admin_uuid IS NULL THEN
    RAISE NOTICE 'No admin user found. Create one in Supabase Dashboard first.';
    RETURN;
  END IF;
...
-- ============================================
-- DONE! Check output for admin user ID
-- ============================================
